...
def contact_not_found(word: str):
    return f'Контакты содержащие {word} не найдены!'


input_id_change_contact = 'Введите ID контакта, который хотите изменить: '

change_contact = ['Введите имя или ENTER, чтобы оставить все без изменений: ',
                  'Введите номер телефона или ENTER, чтобы  оставить все без изменений: ',
                  'Введите комментарий или ENTER, чтобы оставить все без изменений: ', ]
